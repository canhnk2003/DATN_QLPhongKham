  ...
  data.forEach((item, index) => {
    const row = `
        ...
        <td>
            ...
            <div class="m-edit m-tool-icon" data-bs-toggle="modal" data-bs-target="#edit-patient" data-id="${
              item.benhNhanId
            }">
...
function fillEditModal(benhNhan) {
  ...
  // Gán giới tính
  const genderValue =
    benhNhan.gioiTinh === "Nam" ? 0 : benhNhan.gioiTinh === "Nữ" ? 1 : 2;
